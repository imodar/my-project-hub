...
export default function MemberSheet({ locations, selectedMemberId, onMemberSelect, isExpanded, setIsExpanded }: MemberSheetProps) {
  ...
  return (
    <motion.div
      ...
      style={{ height: SHEET_EXPANDED, y: sheetY, bottom: -(SHEET_EXPANDED - SHEET_PEEK) }}
      drag="y"
    ...
    >
      ...
      <div className="flex items-center justify-between px-5 py-2">
        <div>
          <h2 className="text-base font-extrabold text-foreground">أفراد العائلة ({locations.length})</h2>
          <p className="text-xs text-muted-foreground">مواقع الأعضاء</p>
        </div>
