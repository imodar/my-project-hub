...
const en: Translations = {
  ...
  settings: {
    ...
    deleteWarning1: "All your data will be permanently deleted from the server",
    deleteWarning2: "You will not be able to recover any data after deletion",
    deleteWarning3: "You can re-register later but without your previous data",
    deleteConfirmCheck: "I understand this action cannot be undone",
    deleteReasonPlaceholder: "Reason for deletion (optional)",
    deleteAccountBtn: "Delete Account Permanently",
    deletingServer: "Deleting data from server...",
    deletingLocal: "Clearing local data...",
    deleteSuccess: "Account deleted successfully",
    deleteError: "An error occurred while deleting the account",
    deleteSoleAdmin: "You are the sole admin of your family. Assign another admin first.",
  },
